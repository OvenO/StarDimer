...
\newcommand*\hp{\includegraphics[scale=1]{DimerLatexSmbls/hrz_plqt}}
\newcommand*\vp{\includegraphics[scale=1]{DimerLatexSmbls/vrt_plqt}}
% "hprs" for horizontal pre star
\newcommand*\hprs{\includegraphics[scale=1]{DimerLatexSmbls/hrz_pre_star}}
% "hspr" for horizontal star pair
\newcommand*\hspr{\includegraphics[scale=1]{DimerLatexSmbls/hrz_star_pair}}
...
The sum over $p$ is the sum over all plaqquettes on the lattice.

In the star dimer model we introduce the additional potential and kinetic energy terms.

\begin{equation}
    \label{}
    H_{\mathrm{star\ pair\ res}} = a\sum_{p}
        \left(
            \left|
                \hprs
            \right\rangle
...
\begin{equation}
    \label{}
    H_{\mathrm{star\ pair\ diag}} = b\sum_{p}
        \left(
            \left|
                \hprs
            \right\rangle
